...
import { Product, Manufacturer } from "@/app/types";
import { getProduct, updateProduct } from "@/app/hooks/useProducts";
      ...
      <div className="w-[338px] px-2 py-4 rounded-lg bg-slate-100 flex flex-col gap-5">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
          ...
          <div className="flex gap-3 justify-end">
            <button onClick={() => closeModal('editProduct')}>Отмена</button>
